package com.kproject.cedronews.presentation.screens.newsreader.model
...
fun NewsContentModel.fromModel() = NewsContent(id, title, subtitle, imageUrl, content, date)

val fakeNewsContent = NewsContent(
    id = 1,
